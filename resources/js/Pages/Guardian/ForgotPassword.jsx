...
export default function ForgotPassword({ isOpen, onClose }) {
  ...
  useEffect(() => {
    if (isOpen) {
      setData((prev) => ({ ...prev, redirect: 'guardian' }));
    }
  }, [isOpen, setData]);
  ...
  const submit = (e) => {
    ...
    post(route('password.email'), {
      preserveScroll: true,
      onSuccess: () => {
        setSuccessMsg('We have emailed your guardian password reset link.');
        setEmailSent(true);
        reset('email');
      },
      onError: () => {
              ...
              <div className="bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-4 text-blue-100 text-sm leading-relaxed">
                    Enter the email tied to your guardian account and we’ll send a secure reset link straight to your inbox.
                  </p>
                </div>
              ...
              <div className="p-8 md:p-10">
                ...
                {!emailSent ? (
                  <form onSubmit={submit} className="space-y-6 mt-6" noValidate>
                    <div>
                      <label htmlFor="guardian-reset-email" className="block text-sm font-semibold text-gray-700 mb-2">
                        Email Address
                      </label>
                      <div className="relative">
                        <Mail className="absolute left-3 top-3.5 text-gray-400" size={20} />
                        <input
                          id="guardian-reset-email"
                          type="email"
                          value={data.email}
                  ...
                  <div className="mt-8 flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-500 text-sm leading-relaxed">
                        We’ve emailed instructions to reset your guardian password. Open your inbox and click the button inside to set a new password.
                      </p>
                    </div>
