...
export default function ForgotPassword({ isOpen, onClose }) {
  ...
  const submit = (e) => {
    ...
    post(route("password.email"), {
      preserveScroll: true,
      onSuccess: () => {
        setSuccessMsg("We have emailed your password reset link.");
        setEmailSent(true);
        reset("email");
      },
      onError: () => {
              ...
              <div className="bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white p-8 flex flex-col justify-between">
                <div>
                  ...
                  <p className="mt-4 text-blue-100 text-sm leading-relaxed">
                    Enter the email tied to your treasurer account and we’ll send a secure reset link straight to your inbox.
                  </p>
                </div>
                <div className="mt-6 text-xs text-blue-100">
                  <p>Tip: Check your spam folder if you don’t see the message within a minute.</p>
                </div>
              </div>
                  ...
                  <div className="mt-8 flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-500 text-sm leading-relaxed">
                        We’ve emailed instructions to reset your password. Open your inbox and click the button inside to set a new password.
                      </p>
                    </div>
